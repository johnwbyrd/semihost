/*
 * ANSI Backend Tests - Insecure Backend
 *
 * Tests the insecure ANSI backend with real file I/O operations.
...
void run_ansi_insecure_tests(void)
{
    ...
    printf("\nInsecure Backend: %d/%d tests passed\n", tests_passed, tests_run);
}

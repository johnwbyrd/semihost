...
void test_fail_eq(const char *file, int line,
                  const char *a_expr, long a_val,
                  const char *b_expr, long b_val);
void test_fail_mem(const char *file, int line,
                   const char *a_expr, const char *b_expr, size_t n);
...
/* Returns 0 if canaries intact, 1 if pre-canary stomped, 2 if post-canary stomped */

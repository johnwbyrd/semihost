...
- SIGNATURE, RIFF_PTR, DOORBELL, IRQ_STATUS, etc.
...
Parsers MUST follow these rules for correct and forward-compatible operation:
...
**Note:** See Cache Coherency Requirements in Hardware Architecture section for critical cache management details.
...
**Note:** SYS_ELAPSED and SYS_HEAPINFO have special return value encoding. See Special Return Value Encoding for details.

...
static int64_t dummy_flen(void *ctx, int fd)
{
    (void)ctx;
    (void)fd;
    return 0;
...
static int dummy_rename(void *ctx,
...
static int dummy_heapinfo(void *ctx,
                          uint64_t *heap_base, uint64_t *heap_limit,
...
static void dummy_do_exit(void *ctx, unsigned int reason, unsigned int subcode)
{
    (void)ctx;
    (void)reason;
    (void)subcode;
